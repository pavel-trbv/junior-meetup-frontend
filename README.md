...
Обычно в таком случае контент страницы меняют на сообщение об ошибке и кнопкой действия:
...
Таким образом, у пользоваля создается ощущение бесконечного скролла.